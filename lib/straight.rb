...
require_relative 'straight/exchange_rate_bitcoin_adapter'
require_relative 'straight/exchange_rate_bitcoin_adapters/bitpay_adapter'
require_relative 'straight/exchange_rate_bitcoin_adapters/coinbase_adapter'
require_relative 'straight/exchange_rate_bitcoin_adapters/bitstamp_adapter'
require_relative 'straight/exchange_rate_bitcoin_adapters/localbitcoins_adapter'
require_relative 'straight/exchange_rate_bitcoin_adapters/okcoin_adapter'
require_relative 'straight/exchange_rate_bitcoin_adapters/btce_adapter'
require_relative 'straight/exchange_rate_bitcoin_adapters/kraken_adapter'
require_relative 'straight/exchange_rate_bitcoin_adapters/average_rate_adapter'
